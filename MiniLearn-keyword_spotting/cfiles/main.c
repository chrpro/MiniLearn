...
// static q7_t pool1_out[CONV2_OUT_CH*POOL1_OUT_DIM*POOL1_OUT_DIM];
...
uint32_t network(q7_t* input)
{
	...
	// arm_maxpool_q7_HWC(conv2_out, POOL1_IM_DIM, POOL1_IM_CH, POOL1_KER_DIM, POOL1_PADDING, POOL1_STRIDE, POOL1_OUT_DIM, (q7_t *)conv_buffer, pool1_out);

    // save("logs/pool1_out.raw", pool1_out, sizeof(pool1_out));
    
	
	arm_fully_connected_q7_opt(conv2_out, fc1_w, INTERFACE_DIM, INTERFACE_OUT, INTERFACE_BIAS_LSHIFT, INTERFACE_OUT_RSHIFT, fc1_b,
						  fc1_out, fc_buffer);
...
// arm_maxpool_q7_HWC(conv1_out, POOL1_IM_DIM, POOL1_IM_CH, POOL1_KER_DIM, POOL1_PADDING, POOL1_STRIDE, POOL1_OUT_DIM, (q7_t *)conv_buffer, pool1_out);
